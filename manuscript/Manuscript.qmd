...
csl: the-plant-cell.csl #change according to journal
---
...
dit is **echt** zo veel beter ***vette shit***[@oh2014][@van2018; @van2020; @García-González2021; @van2021; @Hayes2019][@van2018a]
teeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeering
omg
wat een text
ik wordt gek 
...
Test of git show. <!--# watdefukisdit! -->
...
```{r, out.width = "100%", fig.cap="**Figure 1. A figure** (A) A nice picture of whatever. (B) legend.  (C) <br> (D) " }
#| echo: false 
...
```{r, out.width = "100%", fig.cap="**Figure 3. Fianlly some ril data** (A) A nice picture. (B) legend.  (C) <br> (D) " }
#| echo: false 

knitr::include_graphics("figures/Figure_roots_complex.png")
```
...
```{r tt, echo=FALSE, eval=TRUE, warning=FALSE}
#| fig-pos: "h"
...
library(xlsx)
hypocotyl_table = read.xlsx("../analysis/data/19-04-24 hypocotyl length form.xlsx",2)#filename and sheet nr.

tt(resources_table, theme = "grid", width = 1, placement = "H") 
tt(hypocotyl_table, theme = "grid", width = 1, placement = "H") 
